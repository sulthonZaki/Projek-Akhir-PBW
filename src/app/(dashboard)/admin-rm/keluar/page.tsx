...
export default function BarangKeluarRMPage() {
  ...
  async function fetchData() {
    ...
    const [transaksiRes, masterRes] = await Promise.all([
      fetch("/api/rm/transaksi?jenis=KELUAR"),
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-500 text-sm mt-1">
            Pengeluaran bahan baku ke produksi
          </p>
        </div>
        ...
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-xl w-full max-w-lg p-6 max-h-[90vh] overflow-y-auto">
            <div className="flex items-center justify-between mb-5">
              <h3 className="font-bold text-[#0f1729]">Input Barang Keluar</h3>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="Tujuan pengeluaran bahan baku"
                  rows={2}
